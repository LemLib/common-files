...
> - Open a bug report or feature request [here](https://github.com/LemLib/<||repo_name||>/issues/new/choose)
...
> If you want to ask a question, we assume that you have read the available [Documentation](<||docs_link||>).

Before you ask a question, it is best to search for existing [Issues](https://github.com/LemLib/<||repo_name||>/issues) that might help you. In case you have found a suitable issue and still need clarification, you can write your question in this issue. In addition, you can also search for existing questions in the [Vex Discord](https://discord.gg/VUStG8p), the [VEX Forum](https://www.vexforum.com/), or our [Discord](https://discord.gg/pCHr7XZUTj).

If you then still feel the need to ask a question and need clarification, we recommend the following:

- Open an [Issue](https://github.com/LemLib/<||repo_name||>/issues/new).
- Provide as much context as you can about what you're running into.
- Provide Kernel, CLI, and <||repo_name||> versions (e.g PROS 3.8.0, CLI 3.4.1, <||repo_name||> 0.4.5)
...
- Make sure that you are using the latest version of <||repo_name||>, PROS, and the CLI.
- Determine if your bug is really a bug and not an error on your side e.g. incorrect chassis setup (Make sure that you have read the [documentation](<||docs_link||>). If you are looking for support, you might want to check [this section](#i-have-a-question)).
- To see if other users have experienced (and potentially already solved) the same issue you are having, check if there is not already a bug report existing for your bug or error in the [bug tracker](https://github.com/LemLib/<||repo_name||>/issues?q=label%3Abug).
- Collect information about the bug:
  - Logger Messages
  - Kernel, CLI, and <||repo_name||> versions
...
- Open an [Issue](https://github.com/LemLib/<||repo_name||>/issues/new). Use the Bug Report issue template.
- Explain the behavior you would expect and the actual behavior.
- Provide the version of the PROS kernel, the PROS CLI, and <||repo_name||>
...
- Read the [documentation](<||docs_link||>) carefully and find out if the functionality is already covered, maybe by an individual configuration.
- Perform a [search](https://github.com/LemLib/<||repo_name||>/issues) to see if the enhancement has already been suggested. If it has, add a comment to the existing issue instead of opening a new one.
- Find out whether your idea fits with the scope and aims of the project. It's up to you to make a strong case to convince the project's developers of the merits of this feature. Keep in mind that we want features that will be useful to the majority of our users and not just a small subset.

<!-- omit in toc -->
#### ✨How Do I Submit a Good Enhancement Suggestion?

Enhancement suggestions are tracked as [GitHub issues](https://github.com/LemLib/<||repo_name||>/issues). You can use the Feature Request issue template upon creation of a new issue.
...
- **Explain why this enhancement would be useful** to most <||repo_name||> users and/or maintainers.
...
- Fetch the kernel: `pros c fetch <||repo_name||>@a.b.c-d.zip`
- Apply the kernel: `pros c apply <||repo_name||>@a.b.c-d`
- Remove the template: `pros c remove <||repo_name||>@a.b.c-d`

In order to contribute to <||repo_name||>, you will need to [fork](https://help.github.com/en/github/getting-started-with-github/fork-a-repo) the repository and clone it to your local machine. You can then [commit](#commit-messages) your changes to your fork. Once you are done, you can [create a pull request](https://help.github.com/en/github/collaborating-with-issues-and-pull-requests/creating-a-pull-request) to the master branch. You can use the [Pull Request Template](https://github.com/LemLib/<||repo_name||>/blob/master/.github/PULL_REQUEST_TEMPLATE.md) to structure your pull request.
...
- Editing the [Doxygen configuration file](https://github.com/LemLib/<||repo_name||>/blob/master/docs/Doxyfile)
- Adding/Editing [Tutorials](https://github.com/LemLib/<||repo_name||>/tree/master/docs/tutorials)
- Opening an [Issue](https://github.com/LemLib/<||repo_name||>/issues) to suggest a change or to report a bug

Changes should be requested via a [Pull Request](https://help.github.com/en/github/collaborating-with-issues-and-pull-requests/creating-a-pull-request) to the <||repo_name||> repository. You can use the [Pull Request Template](https://github.com/LemLib/<||repo_name||>/blob/master/.github/PULL_REQUEST_TEMPLATE.md) to structure your pull request. Additionally, you should verify that the documentation builds correctly on your machine.
...
We use our own style guide for <||repo_name||>. Here are the most important rules:
